...
public class metoder{
	/**
	 * till för att se till så att pogramet inte krachar när anvendaren skriver in en data typ som pograment inte kan hantera. 
	...
	/**
	 * denna mitoden är till för att darton ska välja ett ord som spelarne ska gissa på. ifall man vill splela själv.<br>(en tråkig lista med vardagliga ord )
	...
	/**
	 * denna mitoden är till för att darton ska välja ett ord som spelarne ska gissa på. ifall man vill splela själv.<br>(en lista med referenser till sex, drycks spel, savart humor m.m)
	 * @return ett slumpesigt valt ord 
	 */
	...
	/**
	 * en mitod som anvends för att ta in informaton från anvendaren. (borde anvenda den oftare).
	...
	/**
	 *  dena mitoden avends för att jämföra gissnigen mot det görmda ordet för att den om den hittar en matching ska de sparas. 
	 * @param gess tar in gissnigen om den är en char. en arry omgord till string 
	...
	/**
	 * mitoden är till för att skapa en arry list som är lika lång som ordet fyld med -.<br> för att grafiskt kunna visa hur många bokstäver som ordet inneholler. 
	...
	/**
	 * mitoden är till för att kunna avgär om arrnlisten baln är är samma som det gömda ordet. för att kunna avgöra om spelar har vunit eller inte. 
	 * @param keyword  är ordet som valdes i singelPlayer eller som anvendaren skrev in.
	 * @param investigation är blank en kombenaton av bokstäverna som anvendaren har gisst på och -. 
	 * @return sant eller falst 
	 */
